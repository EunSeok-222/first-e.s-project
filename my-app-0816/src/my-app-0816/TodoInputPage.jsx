...
function TodoInputPage(props) {
  ...
  function handleSubmit(e) {
    ...
    let todoForm = e.target; //전송이벤트 발생 태크
    let title = todoForm.td_title.value; //name솟성으로 접근
    let content = todoForm.td_content.value; //name솟성으로 접근
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <label>
          할일제목 :<input name="td_title" required></input>
        </label>
        <br></br>
        <label>
          할일내용 :<textarea name="td_content" required></textarea>
        </label>
        <br></br>
